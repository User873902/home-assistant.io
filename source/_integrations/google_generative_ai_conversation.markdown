...
The Google Generative AI integration adds a conversation agent powered by [Google's Generative AI, PaLM (also known as Bard)](https://developers.generativeai.google/) in Home Assistant.
